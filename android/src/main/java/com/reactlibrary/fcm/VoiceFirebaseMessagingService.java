...
public class VoiceFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void notify(CallInvite callInvite, int notificationId) {
        ...
        if (callInvite.getState() == CallInvite.State.PENDING) {
            Intent intent = new Intent(this, RNTwilioModule.class);
            intent.setAction(RNTwilioModule.ACTION_INCOMING_CALL);
...
//            SoundPoolManager.getInstance(this).stopRinging();
    ...
    /*
     * Send the CallInvite to the RNTwilioModule. Start the activity if it is not running already.
     */
